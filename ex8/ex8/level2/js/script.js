...
(function(){
    ...
    */
    ...
    var character = new Sprite("player",Math.floor(Math.random() * w_canva), Math.floor(Math.random() * h_canva), CHARACTER_SIZE, CHARACTER_SIZE, "#0f0");
    character.speed = 7;
    sprites.push(character);

    // BOXS
    var boxR = new Sprite("box_red",Math.floor(Math.random() * w_canva), Math.floor(Math.random() * h_canva), CHARACTER_SIZE-10, CHARACTER_SIZE-10, "#09f");
    sprites.push(boxR);
    boxRs.push(boxR);
    boxs.push(boxR);

    var boxP = new Sprite("box_pink",Math.floor(Math.random() * w_canva), Math.floor(Math.random() * h_canva), CHARACTER_SIZE-10, CHARACTER_SIZE-10, "#05f");
    sprites.push(boxP);
    boxPs.push(boxP);
    boxs.push(boxP);
    
    //BUTTONS
    var btnR = new Sprite("btn_red",Math.floor(Math.random() * w_canva), Math.floor(Math.random() * h_canva), CHARACTER_SIZE-20, CHARACTER_SIZE-20, "#09f");
    sprites.push(btnR);
    buttons.push(btnR);
    btnRs.push(btnR);

    var btnP = new Sprite("btn_red",Math.floor(Math.random() * w_canva), Math.floor(Math.random() * h_canva), CHARACTER_SIZE-20, CHARACTER_SIZE-20, "#05f");
    sprites.push(btnP);
    buttons.push(btnP);
    btnPs.push(btnP);

    //NEXTS
    var next = new Sprite("next",Math.floor(Math.random() * w_canva), Math.floor(Math.random() * h_canva), CHARACTER_SIZE-20, CHARACTER_SIZE+30, "#f91");
    sprites.push(next);
    nexts.push(next);
    next.visible = false;
    ...
    // WALLS
    for(var i = 0; i <= 9; i++) {
        var wall = new Sprite("wall",Math.floor(Math.random() * w_canva), Math.floor(Math.random() * h_canva), Math.floor(Math.random() * 100) + 20, Math.floor(Math.random() * WALL_MIN_HEIGHT*10) + 20, "#000")
        sprites.push(wall)
        walls.push(wall);
    }
